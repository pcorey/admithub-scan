...
function buildAlert(alert) {
  ...
  */
  ...
  var line = $('<p>');
  line.append($('<code class="package" title="Installed Package">').text(alert.package.name+'@'+alert.package.version));
  line.append($('<code class="versions" title="Vulnerable Versions">').text(alert.alert.range));
  result.append(line);
